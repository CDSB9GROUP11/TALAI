...
def update_section_vectors_in_df(embedding_llm, json_prompt_output, section_list, df_sections, file_id):
    """
    ...
    for section in section_list:
        ...
        insert_resume_data(section_row)
...
def update_resume_vector_in_df(embedding_llm, resume, df_resume):
    """
